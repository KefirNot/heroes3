...
export default class extends React.PureComponent {
    render() {
        ...
        return (
            <div className="surface" style={styleFactory.tileSize(size.width + 2 + outland.width * 2, size.height + 2 + outland.height * 2)}>
                <Outland className="surface-outland" data={outland.top} />
                <Outland className="surface-outland" data={outland.left} />
                <div className="surface-border-container" style={styleFactory.tileSize(size.width + 2, size.height + 2)}>
                    <Border className="surface-border-horizontal" data={border.top} />
                    <Border className="surface-border-vertical" data={border.left} />
                    <div className="surface-border-content" style={styleFactory.tileSize(size.width, size.height)}></div>
